...
class ConfigManager:
    ...
    public_keys = {
        ...
        "thread_auto_close_response": "Este ticket se ha cerrado automáticamente por inactividad después de {timeout}.",
        "thread_creation_response": "El Staff se comunicará con usted lo antes posible.",
        "thread_creation_footer": "Tu mensaje ha sido enviado",
        "thread_self_closable_creation_footer": "Haga clic en el candado para cerrar el ticket",
        ...
        "disabled_new_thread_response": "Actualmente no aceptamos nuevos tickets.",
        "disabled_new_thread_footer": "Por favor, inténtelo de nuevo más tarde...",
        "disabled_current_thread_title": "No entregado",
        "disabled_current_thread_response": "Actualmente no aceptamos ningún mensaje.",
