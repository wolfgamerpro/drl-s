{
  ...
  "disabled_new_thread_title": {
    ...
    "description": "El título del mensaje se inserta cuando la creación de un nuevo ticket de RequiemSupport está deshabilitada y el usuario intenta crear un nuevo ticket.",
    "examples": [
      "`{prefix}config set disabled_new_thread_title Cerrado`"
    ],
    "notes": [
      "Solo tiene efecto cuando `{prefix}disable` o `{prefix}disable all` esta colocado.",
  ...
  "disabled_new_thread_response": {
    "default": "No aceptamos nuevos tickets.",
    "description": "El cuerpo del mensaje se incrusta cuando RequiemSupport está deshabilitada la creación de un nuevo ticket y el usuario intenta crear un nuevo ticket.",
    "examples": [
      "`{prefix}config set disabled_new_thread_response Nuestro horario de trabajo es entre 8am - 6pm.`"
    ],
    "notes": [
      "Solo tiene efecto cuando `{prefix}disable` or `{prefix}disable all` esta colocado.",
  ...
  "disabled_new_thread_footer": {
    "default": "Por favor, inténtelo de nuevo más tarde...",
    "description": "El pie de página del mensaje se incrusta cuando RequiemSupport está deshabilitada la creación de un nuevo ticket y el usuario intenta crear un nuevo ticket.",
    "examples": [
      "`{prefix}config set disabled_new_thread_footer Contáctanos más tarde`"
    ],
    "notes": [
      "Solo tiene efecto cuando `{prefix}disable` or `{prefix}disable all` esta colocado.",
  ...
  "disabled_current_thread_title": {
    "default": "No entregado.",
    "description": "El título del mensaje se incrusta cuando RequiemSupport DM está deshabilitado y el usuario envía un mensaje directo a RequiemSupport desde el ticket existente.",
    "examples": [
      "`{prefix}config set disabled_current_thread_title Indisponible`"
    ],
    "notes": [
      "Solo tiene efecto cuando `{prefix}disable all` esta colocado.",
  ...
  "disabled_current_thread_response": {
    "default": "No aceptamos ningún mensaje.",
    "description": "El cuerpo del mensaje se incrusta cuando RequiemSupport DM está deshabilitado y el usuario DM requiere RequiemSupport desde el ticket existente.",
    "examples": [
      "`{prefix}config set disabled_current_thread_response En descanso ahora mismo.`"
    ],
    "notes": [
      "Solo tiene efecto cuando `{prefix}disable all` esta colocado.",
  ...
  "disabled_current_thread_footer": {
    "default": "Por favor, inténtelo de nuevo más tarde...",
    "description": "El pie de página del mensaje se inserta cuando RequiemSupport DM está deshabilitado y el usuario DM requiere RequiemSupport desde el ticket existente.",
    "examples": [
      "`{prefix}config set disabled_current_thread_footer Mensaje de regreso!`"
    ],
    "notes": [
      "Solo tiene efecto cuando `{prefix}disable all` esta colocado.",
  ...
  "recipient_color": {
    ...
    "description": "Este es el color de los mensajes enviados por el destinatario, esto se aplica a los mensajes recibidos en el canal del ticket.",
    "examples": [
  ...
  "anon_username": {
    ...
    "description": "Este es el nombre en la sección "autor" enviado por moderadores anónimos en el DM del destinatario.",
    "examples": [
  ...
  "anon_tag": {
    "default": "\"Respuesta\"",
    "description": "Esta es la etiqueta de nombre en la sección de "pie de página" enviado por moderadores anónimos en el DM del destinatario.",
    "examples": [
      "`{prefix}config set anon_tag Miembro de Soporte`"
    ],
    "notes": [
